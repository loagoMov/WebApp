...
import { DiscoveryDomains } from "../resources/discoveryDomains/client/Client.mjs";
...
export class Organizations {
    ...
    get discoveryDomains() {
        var _a;
        return ((_a = this._discoveryDomains) !== null && _a !== void 0 ? _a : (this._discoveryDomains = new DiscoveryDomains(this._options)));
    }
