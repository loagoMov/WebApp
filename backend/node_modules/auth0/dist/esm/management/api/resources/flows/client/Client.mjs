...
import { Vault } from "../resources/vault/client/Client.mjs";
export class Flows {
    ...
    get vault() {
        var _a;
        return ((_a = this._vault) !== null && _a !== void 0 ? _a : (this._vault = new Vault(this._options)));
    }
    /**
    ...
    list() {
        return __awaiter(this, arguments, void 0, function* (request = {}, requestOptions) {
            ...
            return new core.Page({
                ...
                hasNextPage: (response) => { var _a, _b; return ((_a = response === null || response === void 0 ? void 0 : response.flows) !== null && _a !== void 0 ? _a : []).length >= ((_b = request === null || request === void 0 ? void 0 : request.per_page) !== null && _b !== void 0 ? _b : 1); },
                getItems: (response) => { var _a; return (_a = response === null || response === void 0 ? void 0 : response.flows) !== null && _a !== void 0 ? _a : []; },
                loadPage: (response) => {
                    _offset += (response === null || response === void 0 ? void 0 : response.flows) != null ? response.flows.length : 1;
