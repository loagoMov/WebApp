...
export class DiscoveryDomains {
        ...
        return __awaiter(this, arguments, void 0, function* (id, request = {}, requestOptions) {
            const list = core.HttpResponsePromise.interceptFunction((request) => __awaiter(this, void 0, void 0, function* () {
                ...
                switch (_response.error.reason) {
                    ...
                    case "timeout":
                        throw new errors.ManagementTimeoutError("Timeout exceeded when calling GET /organizations/{id}/discovery-domains.");
                    case "unknown":
                        throw new errors.ManagementError({
    ...
    __create(id, request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (_response.error.reason) {
                ...
                case "timeout":
                    throw new errors.ManagementTimeoutError("Timeout exceeded when calling POST /organizations/{id}/discovery-domains.");
                case "unknown":
                    throw new errors.ManagementError({
                        message: _response.error.errorMessage,
                        rawResponse: _response.rawResponse,
     ...
     */
    get(id, discoveryDomainId, requestOptions) {
        return core.HttpResponsePromise.fromPromise(this.__get(id, discoveryDomainId, requestOptions));
    }
    __get(id, discoveryDomainId, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k;
            let _headers = mergeHeaders((_a = this._options) === null || _a === void 0 ? void 0 : _a.headers, mergeOnlyDefinedHeaders({ Authorization: yield this._getAuthorizationHeader() }), requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.headers);
            const _response = yield ((_b = this._options.fetcher) !== null && _b !== void 0 ? _b : core.fetcher)({
                url: core.url.join((_d = (_c = (yield core.Supplier.get(this._options.baseUrl))) !== null && _c !== void 0 ? _c : (yield core.Supplier.get(this._options.environment))) !== null && _d !== void 0 ? _d : environments.ManagementEnvironment.Default, `organizations/${core.url.encodePathParam(id)}/discovery-domains/${core.url.encodePathParam(discoveryDomainId)}`),
                method: "GET",
                headers: _headers,
                queryParameters: requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.queryParams,
                timeoutMs: ((_g = (_e = requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.timeoutInSeconds) !== null && _e !== void 0 ? _e : (_f = this._options) === null || _f === void 0 ? void 0 : _f.timeoutInSeconds) !== null && _g !== void 0 ? _g : 60) * 1000,
            ...
            switch (_response.error.reason) {
                ...
                case "timeout":
                    throw new errors.ManagementTimeoutError("Timeout exceeded when calling GET /organizations/{id}/discovery-domains/{discovery_domain_id}.");
                case "unknown":
                    throw new errors.ManagementError({
                        message: _response.error.errorMessage,
                        rawResponse: _response.rawResponse,
    ...
    __delete(id, discoveryDomainId, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (_response.error.reason) {
                ...
                case "timeout":
                    throw new errors.ManagementTimeoutError("Timeout exceeded when calling DELETE /organizations/{id}/discovery-domains/{discovery_domain_id}.");
                case "unknown":
                    throw new errors.ManagementError({
                        message: _response.error.errorMessage,
                        rawResponse: _response.rawResponse,
    ...
    __update(id_1, discoveryDomainId_1) {
        return __awaiter(this, arguments, void 0, function* (id, discoveryDomainId, request = {}, requestOptions) {
            var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k;
            let _headers = mergeHeaders((_a = this._options) === null || _a === void 0 ? void 0 : _a.headers, mergeOnlyDefinedHeaders({ Authorization: yield this._getAuthorizationHeader() }), requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.headers);
            const _response = yield ((_b = this._options.fetcher) !== null && _b !== void 0 ? _b : core.fetcher)({
                url: core.url.join((_d = (_c = (yield core.Supplier.get(this._options.baseUrl))) !== null && _c !== void 0 ? _c : (yield core.Supplier.get(this._options.environment))) !== null && _d !== void 0 ? _d : environments.ManagementEnvironment.Default, `organizations/${core.url.encodePathParam(id)}/discovery-domains/${core.url.encodePathParam(discoveryDomainId)}`),
            ...
            switch (_response.error.reason) {
                ...
                case "timeout":
                    throw new errors.ManagementTimeoutError("Timeout exceeded when calling PATCH /organizations/{id}/discovery-domains/{discovery_domain_id}.");
                case "unknown":
                    throw new errors.ManagementError({
                        message: _response.error.errorMessage,
                        rawResponse: _response.rawResponse,
