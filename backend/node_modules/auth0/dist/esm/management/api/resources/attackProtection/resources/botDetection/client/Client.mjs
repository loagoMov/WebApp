    ...
    __get(requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (_response.error.reason) {
                ...
                case "timeout":
                    throw new errors.ManagementTimeoutError("Timeout exceeded when calling GET /attack-protection/bot-detection.");
                case "unknown":
                    throw new errors.ManagementError({
    ...
    __update() {
        return __awaiter(this, arguments, void 0, function* (request = {}, requestOptions) {
            ...
            switch (_response.error.reason) {
                ...
                case "timeout":
                    throw new errors.ManagementTimeoutError("Timeout exceeded when calling PATCH /attack-protection/bot-detection.");
                case "unknown":
                    throw new errors.ManagementError({
                        message: _response.error.errorMessage,
                        rawResponse: _response.rawResponse,
