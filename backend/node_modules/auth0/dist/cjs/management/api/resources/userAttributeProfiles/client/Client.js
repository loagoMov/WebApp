        ...
        return __awaiter(this, arguments, void 0, function* (request = {}, requestOptions) {
            const list = core.HttpResponsePromise.interceptFunction((request) => __awaiter(this, void 0, void 0, function* () {
                ...
                switch (_response.error.reason) {
                    ...
                    case "timeout":
                        throw new errors.ManagementTimeoutError("Timeout exceeded when calling GET /user-attribute-profiles.");
                    case "unknown":
                        throw new errors.ManagementError({
    ...
    __listTemplates(requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (_response.error.reason) {
                ...
                case "timeout":
                    throw new errors.ManagementTimeoutError("Timeout exceeded when calling GET /user-attribute-profiles/templates.");
                case "unknown":
                    throw new errors.ManagementError({
                        message: _response.error.errorMessage,
                        rawResponse: _response.rawResponse,
    ...
    __getTemplate(id, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (_response.error.reason) {
                ...
                case "timeout":
                    throw new errors.ManagementTimeoutError("Timeout exceeded when calling GET /user-attribute-profiles/templates/{id}.");
                case "unknown":
                    throw new errors.ManagementError({
                        message: _response.error.errorMessage,
                        rawResponse: _response.rawResponse,
    ...
    __get(id, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (_response.error.reason) {
                ...
                case "timeout":
                    throw new errors.ManagementTimeoutError("Timeout exceeded when calling GET /user-attribute-profiles/{id}.");
                case "unknown":
                    throw new errors.ManagementError({
                        message: _response.error.errorMessage,
                        rawResponse: _response.rawResponse,
    ...
    __delete(id, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (_response.error.reason) {
                ...
                case "timeout":
                    throw new errors.ManagementTimeoutError("Timeout exceeded when calling DELETE /user-attribute-profiles/{id}.");
                case "unknown":
                    throw new errors.ManagementError({
                        message: _response.error.errorMessage,
                        rawResponse: _response.rawResponse,
    ...
    __update(id_1) {
        return __awaiter(this, arguments, void 0, function* (id, request = {}, requestOptions) {
            ...
            switch (_response.error.reason) {
                ...
                case "timeout":
                    throw new errors.ManagementTimeoutError("Timeout exceeded when calling PATCH /user-attribute-profiles/{id}.");
                case "unknown":
                    throw new errors.ManagementError({
                        message: _response.error.errorMessage,
                        rawResponse: _response.rawResponse,
...
exports.UserAttributeProfiles = UserAttributeProfiles;
