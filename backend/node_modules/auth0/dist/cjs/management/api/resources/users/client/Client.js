...
class Users {
    ...
    get connectedAccounts() {
        var _a;
        return ((_a = this._connectedAccounts) !== null && _a !== void 0 ? _a : (this._connectedAccounts = new Client_js_3.ConnectedAccounts(this._options)));
    }
    get enrollments() {
        var _a;
        return ((_a = this._enrollments) !== null && _a !== void 0 ? _a : (this._enrollments = new Client_js_4.Enrollments(this._options)));
    }
    get federatedConnectionsTokensets() {
        var _a;
        return ((_a = this._federatedConnectionsTokensets) !== null && _a !== void 0 ? _a : (this._federatedConnectionsTokensets = new Client_js_5.FederatedConnectionsTokensets(this._options)));
    }
    get identities() {
        var _a;
