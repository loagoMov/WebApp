...
class Organizations {
    ...
    get discoveryDomains() {
        var _a;
        return ((_a = this._discoveryDomains) !== null && _a !== void 0 ? _a : (this._discoveryDomains = new Client_js_2.DiscoveryDomains(this._options)));
    }
    get enabledConnections() {
        var _a;
        return ((_a = this._enabledConnections) !== null && _a !== void 0 ? _a : (this._enabledConnections = new Client_js_3.EnabledConnections(this._options)));
    }
    get invitations() {
        var _a;
        return ((_a = this._invitations) !== null && _a !== void 0 ? _a : (this._invitations = new Client_js_4.Invitations(this._options)));
    }
    get members() {
        var _a;
        return ((_a = this._members) !== null && _a !== void 0 ? _a : (this._members = new Client_js_5.Members(this._options)));
    }
    /**
