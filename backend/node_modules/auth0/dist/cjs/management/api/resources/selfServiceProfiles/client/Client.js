...
exports.SelfServiceProfiles = void 0;
...
class SelfServiceProfiles {
    ...
    get customText() {
        var _a;
        return ((_a = this._customText) !== null && _a !== void 0 ? _a : (this._customText = new Client_js_1.CustomText(this._options)));
    }
    get ssoTicket() {
        var _a;
        return ((_a = this._ssoTicket) !== null && _a !== void 0 ? _a : (this._ssoTicket = new Client_js_2.SsoTicket(this._options)));
    }
    /**
    ...
    list() {
        return __awaiter(this, arguments, void 0, function* (request = {}, requestOptions) {
            ...
            return new core.Page({
                ...
                hasNextPage: (response) => { var _a, _b; return ((_a = response === null || response === void 0 ? void 0 : response.self_service_profiles) !== null && _a !== void 0 ? _a : []).length >= ((_b = request === null || request === void 0 ? void 0 : request.per_page) !== null && _b !== void 0 ? _b : 1); },
                getItems: (response) => { var _a; return (_a = response === null || response === void 0 ? void 0 : response.self_service_profiles) !== null && _a !== void 0 ? _a : []; },
                loadPage: (response) => {
                    _offset += (response === null || response === void 0 ? void 0 : response.self_service_profiles) != null ? response.self_service_profiles.length : 1;
...
exports.SelfServiceProfiles = SelfServiceProfiles;
