        ...
        <div className="min-h-screen bg-gray-50 py-12">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="text-center">
                    <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Top Recommendations</h2>
                ...
                <div className="mt-12 grid gap-8 lg:grid-cols-3 lg:gap-x-8">
                    {recommendations.map((product, index) => (
                        <div key={product.id} className={`relative flex flex-col rounded-2xl border bg-white p-8 shadow-sm hover:shadow-lg transition-shadow ${index === 0 ? 'border-primary ring-2 ring-primary' : 'border-gray-200'}`}>
                            {index === 0 && (
                            ...
                            <div className="flex-1">
                                ...
                                <div className="mt-4 flex items-baseline text-gray-900">
                                    ...
                                    <span className="ml-1 text-xl font-semibold text-gray-500">/{product.frequency.toLowerCase()}</span>
                                </div>
                                ...
                                <div className="mt-6">
                                    <div className="flex items-center">
                                        ...
                                        <span className="ml-2 text-sm font-medium text-gray-700">{product.score}% Match</span>
                                    </div>
                                </div>
                                ...
                                <ul className="mt-6 space-y-4">
                                    {product.tags.map((tag) => (
                                        <li key={tag} className="flex items-start">
                                            ...
                                            <p className="ml-3 text-base text-gray-700">{tag}</p>
                                        </li>
                                    ))}
                                </ul>
                            </div>
